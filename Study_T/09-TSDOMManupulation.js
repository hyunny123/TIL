var sub = document.querySelector("#title");
if (sub != null) {
...
buttonclick === null || buttonclick === void 0 ? void 0 : buttonclick.addEventListener("click", function () {
    console.log("클릭클릭!!");
});
